                ...
                children: [
                  ...
                  Transform.translate(
                    offset: Offset(
                      -screenWidth * 0.02,
                      0,
                    ), // Mover 2% del ancho hacia la izquierda
                    child: IconButton(
                      onPressed: () => Get.back(),
                      icon: Icon(
                        Icons.arrow_back,
                      ...
                      if (controller.selectedSkills.isNotEmpty) {
                        return Wrap(
                          ...
                          children: controller.selectedSkills.map((uniqueId) {
                            ...
                            String skillName = controller
                                .getSkillNameFromUniqueId(uniqueId);
                            return Container(
                ...
                child: SingleChildScrollView(
                  child: Obx(
                    () => Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Lista de categorías principales - solo mostrar si no hay categorías expandidas
                        ...
                        if (controller.expandedCategories.isNotEmpty) ...[
                          ...
                          Row(
                            children: [
                              GestureDetector(
                                onTap: () => controller.collapseAllCategories(),
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                    horizontal: 12,
                                    vertical: 8,
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: controller
                                        ...
                                        .map((subcategory) {
                                          final uniqueId = controller
                                              .getUniqueSubcategoryId(
                                                subcategory,
                                              );
