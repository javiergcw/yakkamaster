...
class _EditPersonalDetailsScreenState extends State<EditPersonalDetailsScreen> {
  ...
  final TextEditingController _lastNameController = TextEditingController(text: 'testing');
  ...
  final TextEditingController _birthCountryController = TextEditingController(text: 'Australia');
