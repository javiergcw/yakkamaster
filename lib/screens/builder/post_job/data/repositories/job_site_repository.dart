...
class JobSiteRepositoryImpl implements JobSiteRepository {
  ...
  final List<JobSiteDto> _jobSites = [
    JobSiteDto(
      ...
      status: JobSiteStatus.inProgress,
    ),
    JobSiteDto(
      id: '2',
      name: 'Labour hire and Jobs YAKKA',
      city: 'Albury-Wodonga',
      address: '123 Main Street',
      code: '123 456',
      location: 'Albury-Wodonga',
      description: 'Test site for Yakka Labour',
      status: JobSiteStatus.finished,
    ),
    JobSiteDto(
      id: '3',
      name: 'Adelaide Hills Construction',
      city: 'Adelaide Hills',
    ...
    JobSiteDto(
      id: '4',
      name: 'Petersham Development',
      city: 'Petersham',
      address: '10 Bent Street',
      code: '345 678',
      location: 'Petersham',
    ...
    JobSiteDto(
      ...
      code: '901 234',
      location: 'Melbourne',
      description: 'Restaurant construction project',
      status: JobSiteStatus.inProgress,
    ),
    JobSiteDto(
      id: '6',
